...
- [ ] Add integration tests for group schedule mutation and query/test - setup/login/session restart persistence and blocklist sync now have file-backed API integration tests.
