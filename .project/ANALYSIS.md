...
- Frontend component tests now cover first-run setup, authenticated dashboard rendering, query test submission, and settings PATCH payloads with Vitest/Testing Library.
