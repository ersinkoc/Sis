...
Client, session, and custom allow/block list records are also mirrored into normalized SQLite
tables and served from those tables when the SQLite backend is active.
